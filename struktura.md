...
Az alapstruktúra egy fa, amely ideális \(a [Dunbar számhoz](https://en.wikipedia.org/wiki/Dunbar's_number) közeli\) méretű csoportokat tartalmaz mint leveleket, és a csomópontjainak \(a "metacsoport"oknak\) a fokszáma is az ideális körüli.
